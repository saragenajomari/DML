    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="logo">
                    <a href="<?php echo site_url('Pages/staff_home_page'); ?>"><img src="<?php echo base_url().'assets/image/logo.png'; ?>" alt="merkery_logo" class="hidden-xs hidden-sm">
                    </a>
                </div>
                <div class="navi">
                    <ul>
                        <li><a href="<?php echo site_url('Pages/staff_home_page'); ?>"><i class="fa fa-user-plus" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Students</span></a></li> 
                        <li><a href="<?php echo site_url('Pages/staff_inventory_page'); ?>"><i class="fa fa-cubes"></i><span class="hidden-xs hidden-sm">Inventory</span></a></li>

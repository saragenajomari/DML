...
$(document).ready(function(event){
    ...
    function check_details(){
        ...
        if (status == 'available') {
            ...
            document.getElementById('item_value').disabled = true;;
            document.getElementById('item_quantity').disabled = true;
            document.getElementById('addQuan').disabled = true;
            document.getElementById('minusQuan').disabled = true;
        }
    }
    ...
    $('#submit').click(function(e){
        ...
        var status = $("#status option:selected" ).val();
            ...
            swal({
                title: "Are you sure you want update this Item?",
                text: "",
                icon: "warning",
                buttons: true,
                dangerMode: true,
...
<div class="user-dashboard">
	...
	<div class="form-add col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="item_code" id="item_code" placeholder="Item Code" value="<?php echo $data_item->item_code; ?>">
            </div>
        </div><br><br><br>
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="item_name" id="item_name" placeholder="Item Name" value="<?php echo $data_item->item_name; ?>">
            </div>
        </div><br><br> 
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="item_value" id="item_value" placeholder="Value" value="<?php echo $data_item->value; ?>">
            </div>
        </div><br><br> 
        ...
        <div class="form-group">
            ...
            <div class="col-md-9" style=""> 
                <input type="number" class="form-control" name="item_quantity" id="item_quantity" placeholder="Quantity" value="<?php echo $data_item->quantity; ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select class="form-control" id="status" name="status">
                    ...
                    <option <?php if($data_item->status == 'available'){ echo 'selected';}?> value="available">Available</option>
                    <option <?php if($data_item->status == 'broken'){ echo 'selected';}?> value="broken">Broken</option>
                    <option <?php if($data_item->status == 'repair'){ echo 'selected';}?> value="repair">Repaired</option>
        ...
        <div class="form-group">
            <div class="col-md-9" style=""> 
                <button type="button" id="submit" style="float: left" class="btn btn-success"><i class="fa fa-plus"></i> Update</button>
            </div>
        </div><br><br> 
        <?php } ?>
        </form>
...
var ready_itemCode = 1;
var ready_itemName = 1;
var ready_itemValue = 1;
